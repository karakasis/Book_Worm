...
public class GridAdapter3 extends RecyclerView.Adapter<GridAdapter3.ViewHolder> {
  ...
  @Override
  public void onBindViewHolder(@NonNull GridAdapter3.ViewHolder holder, int position) {
    ...
    Book book = data.get(pos);
      ...
      holder.bookView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
          MyApp.getInstance().manualAddMenu.bookClick(pos);
        }
  ...
  @Override
  public void onViewDetachedFromWindow(final GridAdapter3.ViewHolder holder)
  {
