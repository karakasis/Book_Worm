package com.example.xrhstos.bookapp.transformation;
...
public class RoundCorners implements Transformation {
  ...
  public RoundCorners(int radius, int margin) {
    this(radius, margin, CornerType.ALL);
  }

  public RoundCorners(int radius, int margin, CornerType cornerType) {
    mRadius = radius;
    mDiameter = radius * 2;
    mMargin = margin;
